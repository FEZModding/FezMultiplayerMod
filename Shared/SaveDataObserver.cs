                                ...
                                if (LevelManager.Name == keys[1])
                                {
                                    if (keys.Length > 2)
                                    {
                                        ...
                                        case "InactiveTriles":
                                            ...
                                            LevelManager.RecullAt((TrileEmplacement)newVal);
                                            break;
                                    ...
                                    {
                                        if (typeof(LevelSaveData).Equals(newVal?.GetType() ?? oldval?.GetType()))
                                        {
                                            saveData.World[keys[1]] = (LevelSaveData)newVal;
                                        }
                                    }
                                }
                                else
